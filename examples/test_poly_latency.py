                    ...
                    async for raw_msg in websocket:
                        ...
                        for message in messages:
                            ...
                            if ts_value is not None:
                                #print(f"Timestamp: {ts_value:.3f}", end=' | ')
                                #print(f"Current : {current_time:.3f}", end=' | ')
                                print(f"Latency : {(current_time*1000 - ts_value):.1f} ms", end=' | ')
                            else:
                                print("Timestamp: n/a", end=' | ')
                            #print(f"Latency : {(current_time - timestamp) * 1000:.1f} ms", end=' | ')
